...
def cretirion(batch):
    '''
    :param batch: A mini batch of data, for BPR  batch.shape = [bs*3], for AttentionNCE batch.shape = [bs*(1+M+N)]
    :return:
    '''
    if args.loss == 'BPR':
        ...
        loss = -torch.log(torch.sigmoid(xui-xuj)).mean()
        return loss



    elif args.loss == 'AttentionNCE':
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='100k', help='Dataset name, choose from [100k,1m, gowalla, yelp2018]')
    ...
    parser.add_argument('--loss', default='AttentionNCE', type=str, help='Choose Loss Function, choose from [BPR, AttentionNCE]')
